...
function Bio() {
  return (
    <Box
      className="general__div_bio"
      bg={useColorModeValue("#D8BEAF", "#29282E")}
    >
      <Box className="bio__main_div">
        <Section delay={0.1}>
          <Box className="bio_my_story">
            ...
            <Text as="u" className="bio_my_story_date">
              1988
            </Text>
            ...
            <Text>
              Completed a masters degree in Logic & Philosophy of Science
            </Text>
            ...
            <Text>
              During the pandemic, went to engineering school to learn code
            </Text>
            <Box className="bio_my_story_text_box">
              <List>
                <ListItem className="bio_my_story_text">
            ...
            <Text>
              Internship -> Full Stack dev at{" "}
              <Link
                className="bio_my_story_link"
                href="https://www.play-in.com/"
                target="_blank"
                rel="noopener"
              >
