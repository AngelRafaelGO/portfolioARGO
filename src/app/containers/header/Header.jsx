      ...
      <Box className="header__main_div">
        <Section delay={0.1}>
          <Box
            ...
            bg={useColorModeValue("red.200", "teal.500")}
          >
            <Text>
              Hello! I'm a full stack developer based in Paris &#128681;
            </Text>
          </Box>
        </Section>
        <Section delay={0.1}>
          <Box className="header__my_information">
            <Box className="header__about_me">
              ...
              <Text>
                I've always been a tech enthusiast, since I was a teen &#129299;
              </Text>
              <Text>
                As a developer, I mostly write scripts and query databases. I
                also work with REST api's, using both javascript and php
                framworks. I do my best to write clean, maintainable and
                scalable code
              </Text>
              <Text>
                Design-wise, I enjoy creating minimalistic and functional UI's
              </Text>
              <Text>
                When I'm not doing work, I enjoy developing games, playing them,
                cycling, running and playing board games. I'm a fan of sci-fi
                movies and european literature
              </Text>
            </Box>
            <Box className="header__profile_picture">
              <Image
                className="header__my_photo"
                borderRadius="full"
                src={Chris_me}
                alt="angel's picture"
              />
          ...
          <Box className="header__amy_container">
            <Box>
              ...
              <Box className="header__amy_like_button">
                <Text className="header__amy_like_button_text">
                  Click to like!
                </Text>
                <IconButton
                  aria-label="like amy"
                ...
                <Text
                  ...
                  className="header__like_counter"
                >
                  {totalLikes}
                </Text>
              </Box>
